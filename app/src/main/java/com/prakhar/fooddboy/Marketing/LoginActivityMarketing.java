...
public class LoginActivityMarketing extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_login_marketing);
                ...
                if (snapshot.exists()) {
                    for (DataSnapshot userSnapshot : snapshot.getChildren()) {
                        ...
                        if (user != null && user.getMobile().equals(userPassword)) {
                            Intent intent = new Intent(LoginActivityMarketing.this, ProfileActivityMarketing.class);
...
//                            intent.putExtra("address", user.getAddress());
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(LoginActivityMarketing.this, "Database error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}
