...
import com.prakhar.fooddboy.Admin.ReadAdmin;
import com.prakhar.fooddboy.Marketing.ReadM;

public class ViewAllDataAdmin extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    select.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View v) {
            if (selectedStaffType.equals("Back Office Data")) {
                ...
                Intent intent = new Intent(ViewAllDataAdmin.this, ReadAdmin.class);
                startActivity(intent);
            } else if (selectedStaffType.equals("CHOOSE OPTION")) {
                Toast.makeText(ViewAllDataAdmin.this, "Please select any one", Toast.LENGTH_SHORT).show();

            } else if (selectedStaffType.equals(("Orders"))) {
                Intent intent = new Intent(ViewAllDataAdmin.this, ReadM.class);
                startActivity(intent);
