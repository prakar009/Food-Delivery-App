...
public class fileAdapterUser extends FirebaseRecyclerAdapter<modelFileUser, fileAdapterUser.myviewholder>
{

    public fileAdapterUser(@NonNull FirebaseRecyclerOptions<modelFileUser> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull final myviewholder holder, int position, @NonNull final modelFileUser model) {
        ...
        holder.textdislike.setText(String.valueOf(model.getNod()));
                ...
                holder.img1.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent intent=new Intent(holder.img1.getContext(), viewpdfUser.class);
    ...
    public myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.singelrowdesignuser,parent,false);
